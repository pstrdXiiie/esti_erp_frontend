...
const NAMING_SERIES_OPTIONS = ["JV-.YYYY.-", "JV-MANUAL-"]
...
export default function JournalVoucherEntryPage() {
  ...
  return (
    <div className="grid max-w-3xl gap-6">
      <div>
        <h1 className="text-2xl font-semibold text-zinc-900">Journal Voucher</h1>
        <p className="mt-1 text-sm text-zinc-500">Record a manual journal entry.</p>
      </div>
